...
<head>
    <meta charset="utf-8">
    <title>It knowledge skills - Online Courses HTML Template</title>
        ...
        <div class="row align-items-center py-4 px-xl-5">
            <div class="col-lg-3">
                <a href="" class="text-decoration-none">
                    <h1 class="m-0"><span class="text-primary">IT</span>Knowledge</h1>
                </a>
            </div>
            <div class="col-lg-3 text-right">
                <div class="d-inline-flex align-items-center">
                    ...
                    <div class="text-left">
                        ...
                        <small>123 Street, SG Highway, Gujarat</small>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 text-right">
                <div class="d-inline-flex align-items-center">
                    ...
                    <div class="text-left">
                        ...
                        <small>itknowledge@example.com</small>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 text-right">
